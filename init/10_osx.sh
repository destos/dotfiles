...
if [[ "$(which brew)" ]]; then
  ...
  cask_apps=(launchrocket alfred asepsis qlstephen vagrant virtualbox google-chrome iterm2 handbrake shortcat firefox steam vlc beamer seil mailbox witch hammerspoon dash totalfinder)
